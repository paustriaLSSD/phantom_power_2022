...
Game.prototype.init = function() {
  this.phantomPower = new PhantomPower(this.STAGE_WIDTH, this.STAGE_HEIGHT, this.stage);
  this.phantomPower.init()
}
...
Game.prototype.update = function (pEvent) {
    ...
    if (this.phantomPower) {
      this.phantomPower.update();
    }
